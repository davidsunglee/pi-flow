...
7. **Harden the plan against ambiguous fenced examples.** Run:
   ```
   pi-flow helper _shared/scripts/plan_fence_hardening --plan "{PLAN_PATH}" --rewrite-in-place
   ```
