...
❌ Performative agreement before verification
❌ "Let me implement that now" (before checking against codebase)
```

Verify and evaluate before agreeing; act instead of performing agreement.
